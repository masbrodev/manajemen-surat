                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="nomor_agenda" id="nomor_agenda" value="{{ $sk->nomor_agenda }}" placeholder="Nomor Agenda" oninvalid="this.setCustomValidity('Lengkapi Inputan')" required="" oninput="setCustomValidity('')">
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea type="text" class="form-control" name="tls" id="tls" placeholder="Tindak Lanjut Staf">{{ $sk->tls }}</textarea>
                                </div>
                            </div>
                        </div>
